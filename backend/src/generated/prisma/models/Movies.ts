...
export type GetMoviesGroupByPayload<T extends MoviesGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type MoviesWhereInput = {
  ...
  released?: Prisma.DateTimeFilter<"Movies"> | Date | string
}
...
export type MoviesScalarWhereWithAggregatesInput = {
  ...
  released?: Prisma.DateTimeWithAggregatesFilter<"Movies"> | Date | string
}
...
export type MoviesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "released", ExtArgs["result"]["movies"]>
...
export interface MoviesFieldRefs {
  ...
  readonly released: Prisma.FieldRef<"Movies", 'DateTime'>
}
